module.exports = [
  {
    text: '快速开始',
    link: '/zh/notes-vuepress/getting-started.html'
  },
  {
    text: 'Book',
    link: '/zh/notes-vuepress/book/'
  },
  {
    ...
    items: [
      {
        ...
        items: [
          {
            text: 'FAQ',
            link: '/zh/notes-vuepress/faq.html'
          },
          {
            text: 'Markdown Demo',
            link: '/zh/notes-vuepress/markdown-demo.html'
          }
        ]
      },
      {
        ...
        items: [
          {
            text: 'notes-vuepress Repo',
            link: 'https://github.com/hedzr/notes-vuepress'
          },
          {
            text: 'hedzr on github.com',
